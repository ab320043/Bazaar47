      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8 lg:px-12 py-16 md:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {tourData.map((stop, index) => {
            // Check if this is the Tampa card (Announcement Soon!)
              ...
              >
                ...
                <div className="flex flex-col bg-plaster px-4 py-4 grow">
                  ...
                  <div className="w-full mt-auto">
                    {isTampa ? (
                      // Tampa: Non-clickable button with no arrow
                      <button 
                        className="w-full rounded-2xl bg-[#341B1C] h-12 md:h-14 text-center font-host-grotesk text-[16px] md:text-[20px] font-semibold text-plaster opacity-80 cursor-default"
                        disabled
                      >
                        {stop.price}
                      </button>
                    ) : (
                      // Other cities: Clickable button with arrow
