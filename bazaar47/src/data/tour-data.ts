...
export const tourData: TourCity[] = [
  ...
  },
  {
    ...
    ticketLink: '#',
    venueDetails: 'Gulf Coast is a unique community space that hosts events, workshops, and cultural gatherings. The venue is known for its welcoming atmosphere and commitment to community building.',
